...
type Module = { icon: React.ReactNode; label: string; description: string; accent: string; href?: string };

const MODULES_HOSPITAL_ADMIN: Module[] = [
  {
  ...
  },
  {
    ...
    label: 'Roles',
    description: 'Define staff roles & permissions',
    accent: 'violet',
  },
  {
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {MODULES_HOSPITAL_ADMIN.map((mod) => {
              const inner = (
                <>
